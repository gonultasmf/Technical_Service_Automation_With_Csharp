    ...
    class Tema
    {
        ...
        public Tema(int index)
        {
            ...
            if (nowTheme.Equals(1))
            {
                ...
                buttonBackColor = Color.FromArgb(208, 255, 255);
                ...
                //textBorderColor = Color.FromArgb(237, 255, 255);
                ...
                dateBackColor = ColorTranslator.FromHtml("white");
            ...
            else if (nowTheme.Equals(0))
            {
                ...
                tableCellBackColor = Color.LightGray;
